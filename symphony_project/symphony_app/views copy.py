...
def save_entity(request):
    ...
    try:
        ...
        return JsonResponse({'error': f'Failed to retrieve the webpage: {str(e)}'}, status=500)
    finally:
        driver.quit()
    ...
    # If you want to save entities to the database, handle that here.
    # For example:
    # for entity in entities:
    #     EntityModel.objects.create(**entity)
...
def extract_entities(html_content):
    ...
    return {'artists': artists, 'programs': programs}
